...
def lambda_handler(event, context):
    """Sample Lambda Token Authorizer Function
    Inspired from https://github.com/awslabs/aws-apigateway-lambda-authorizer-blueprints/blob/master/blueprints/python/api-gateway-authorizer-python.py
    References: https://docs.aws.amazon.com/apigateway/latest/developerguide/apigateway-use-lambda-authorizer.html
    """

    authentication = event["queryStringParameters"]["auth"]
    # To avoid Authorization TTL
    principal_id = "user%04d" % random.randrange(0, 1000)

    # arn:aws:execute-api:eu-west-1:123456789012:u5eqf1ivj5/Prod/GET/execute/
    ...
    if authentication == 'allow':
        policy.allowMethod(HttpVerb.GET, "/"+api_gateway_arn_tmp[3]+"/*")
    elif authentication == 'deny':
